...
from classes.adminforms import ClassEditForm, ClassCancelForm
from classes.models.classParent import ClassParent
from classes.models.classInstance import ClassInstance
from classes.models.classKeyword import ClassKeyword
...
class ClassParentAdmin(admin.ModelAdmin):
    ...
    def save_related(self, request, form, formsets, change):
        ...
        new_edition_length=len(edition_data)-len(class_parent.editions.all())
...
def create_class_instances_when_creating_parent(parent):
...
def edit_instances(this_class_parent,data_list):
    for data in data_list:
        ...
        if original_date:
            ...
            q=Q(date__gt=datetime.date.today())
            ...
            if recur_end_date: 
                ...
                if ClassInstance.objects.filter(date__gte=old_recur_end_date):
